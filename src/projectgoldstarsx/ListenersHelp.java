...
public class ListenersHelp
{
    ...
    public static class LocationListener implements MouseListener
    {
        public void mousePressed(MouseEvent e)
        {
            new HelpLocation();
    ...
    public static class NicknameListener implements MouseListener
    {
        public void mousePressed(MouseEvent e)
        {
            new HelpNickname();
    ...
    public static class ErrorsLogListener implements MouseListener
    {
        public void mousePressed(MouseEvent e)
        {
            new HelpErrorLog();
